...
def loop360(x: float|np.ndarray):
	"""
...
def loop180(x: float|np.ndarray):
	"""
...
def azimuth_rmse(x1: np.ndarray | float, 
                 x2: np.ndarray | float) -> np.ndarray | float:
	"""
...
def compute_aphi(phi: np.ndarray | float, 
